...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!article) {
    return { title: 'Article Not Found | Interim Quest' }
  }

  return {
    title: `${article.title} | Interim Quest`,
    description: article.meta_description || article.excerpt || 'Read this article on Interim Quest',
  }
}
    ...
    <article className="min-h-screen bg-gray-50">
      ...
      <header className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-900 text-white">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          {/* Breadcrumb */}
          <nav className="mb-8">
            <Link href="/interim-jobs-articles" className="text-purple-200 hover:text-white transition-colors text-sm">
              ← Back to Articles
            </Link>
          </nav>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex justify-between items-center">
          <Link href="/interim-jobs-articles" className="text-purple-700 hover:text-purple-900 font-medium flex items-center gap-2">
