...
const calculators = [
  ...
  },
  {
    ...
    description: 'Calculate your potential earnings as a interim executive. Factor in day rate, clients, and working patterns to see annual income.',
    icon: '💰',
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span>Exploring a transition to interim work</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">✓</span>
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <ul className="space-y-3 text-gray-600">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">✓</span>
                  <span>Building a business case for interim leadership</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">✓</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-purple-500 mt-1">✓</span>
                  <span>Budgeting for interim executive support</span>
                </li>
              </ul>
              <Link
