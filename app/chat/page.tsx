...
export default function ChatPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: firstName
        ? `Hi ${firstName}! I'm your Interim Quest assistant. I can help you find information about interim jobs, answer questions about our articles, and provide guidance on interim executive careers. What would you like to know?`
        : "Hi! I'm your Interim Quest assistant. I can help you find information about interim jobs, answer questions about our articles, and provide guidance on interim executive careers. What would you like to know?",
    },
  ])
  ...
  useEffect(() => {
    if (firstName && messages.length === 1 && messages[0].role === 'assistant') {
      setMessages([{
        role: 'assistant',
        content: `Hi ${firstName}! I'm your Interim Quest assistant. I can help you find information about interim jobs, answer questions about our articles, and provide guidance on interim executive careers. What would you like to know?`,
      }])
    }
      ...
      <div className="bg-purple-700 text-white py-8">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-purple-100">
            Ask questions about interim jobs, get career advice, or explore our articles
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 py-6 flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="flex gap-3">
          <input
            ...
            placeholder="Ask about interim jobs, articles, or career advice..."
        ...
        <div className="text-center mt-4 space-y-2">
          ...
          <p className="text-xs text-gray-600">
            ...
            <Link href="/interimjobsuk" className="text-purple-600 hover:underline">
              jobs page
            </Link>
            .
          </p>
