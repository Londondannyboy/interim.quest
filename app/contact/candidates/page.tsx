      ...
      <section className="bg-gradient-to-r from-purple-50 to-purple-100 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600">
            Have questions about interim roles or want to share feedback? We&apos;d love to hear from you.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <Card>
              ...
              <p className="text-gray-600 text-sm">
                <a href="mailto:careers@interim.quest" className="text-purple-700 hover:text-purple-900">
                  careers@interim.quest
                </a>
              </p>
            </Card>
