      ...
      <section className="bg-gradient-to-r from-purple-50 to-purple-100 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600">
            Post a job or get in touch with our team about hiring interim executives.
          </p>
        </div>
      </section>
            ...
            {submitStatus === 'success' ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Input
                  ...
                  placeholder="e.g., Interim CFO, Interim CMO"
                  required
                />
              ...
              {[
                {
                  ...
                  desc: 'Access experienced interim executives pre-screened for quality',
                },
                {
                  icon: '⚡',
                ...
                },
                {
                  ...
                  desc: 'All candidates vetted and experienced in interim work',
                },
                {
                  icon: '📊',
                  title: 'Analytics',
