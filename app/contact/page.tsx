...
export const metadata: Metadata = {
  title: 'Contact Us | Interim Quest',
  description: 'Get in touch with Interim Quest. Whether you\'re a job seeker or hiring company.',
}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Link href="/contact/companies">
              <div className="border-2 border-gray-200 rounded-lg p-8 hover:border-gray-900 hover:shadow-lg transition cursor-pointer h-full">
                ...
                <p className="text-gray-600 mb-6">
                  Looking to hire interim executives or specialist talent? Let us know about your open roles and requirements.
                </p>
