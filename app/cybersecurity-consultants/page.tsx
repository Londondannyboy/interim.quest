    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Cybersecurity consultants help organisations protect their systems, data, and reputation from cyber threats. On an interim basis, they provide expert guidance without the overhead of full-time security staff.</p>
