    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-2xl mb-8">Hire experienced finance professionals on an interim basis. Get expert financial strategy, planning, and analysis without the cost of a full finance team.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Finance consultants help businesses make better financial decisions, raise capital, and build robust financial operations. On an interim basis, they bring CFO-level expertise without the full-time commitment.</p>
