    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-gray-600">Unlike other C-suite roles, CEO positions rarely work on an interim basis due to the all-encompassing nature of the role. Interim CEO is the appropriate model for temporary executive leadership.</p>
        </div>
      </section>
