          ...
          <div className="prose prose-lg prose-gray max-w-none">
            ...
            <div className="bg-gray-50 p-8 my-10 border-l-4 border-pink-500">
              <p className="text-xl font-semibold text-gray-900 mb-0">
                "Your people are your competitive advantage. An interim CHRO ensures you attract, develop, and retain the talent you need to win."
              </p>
            </div>
            <h3 className="text-2xl font-black text-gray-900 mt-12 mb-4">Beyond HR Administration</h3>
            <p>
              Many growing companies have operational HR—someone handling payroll, policies, and admin—but lack strategic people leadership. An interim CHRO provides that strategic layer: thinking about how to build culture, develop leaders, and create an organisation where great people want to work.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: 'Get 15+ years of HR experience applied to your challenges. An interim CHRO brings proven approaches to building great organisations.',
                stat: '15+',
              ...
              },
              {
                ...
                description: 'HR mistakes are expensive—bad hires, compliance issues, culture problems. An interim CHRO helps you avoid the pitfalls.',
                stat: '£100k+',
