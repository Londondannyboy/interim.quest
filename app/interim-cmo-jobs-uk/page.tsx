        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900">
              How Much Can You Earn as a Interim CMO?
            </h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">
              ...
              <span className="text-amber-600">Interim CMO Jobs UK</span>
            </h2>
          ...
          <figure className="mb-16 -mx-6 lg:-mx-16">
            <img
              ...
              alt="Interim CMO jobs UK - marketing executive leading strategy meeting with team"
              className="w-full h-80 md:h-96 object-cover"
            />
            <figcaption className="text-sm text-gray-500 mt-3 px-6 lg:px-16">
              Marketing leaders across the UK are embracing interim work
            </figcaption>
          </figure>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900">
              Common Questions About Interim CMO Jobs UK
            </h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/interim-jobs-london" className="text-gray-600 hover:text-amber-600 font-medium transition-colors">Jobs London</Link>
              <Link href="/interim-cfo-jobs-uk" className="text-gray-600 hover:text-amber-600 font-medium transition-colors">CFO Jobs UK</Link>
              <Link href="/interim-cto-jobs-uk" className="text-gray-600 hover:text-amber-600 font-medium transition-colors">CTO Jobs UK</Link>
            </div>
          </div>
        </div>
      </section>
