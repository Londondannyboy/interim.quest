...
export default function InterimCMOPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-gray max-w-none">
            <p className="text-xl text-gray-600 leading-relaxed mb-6">
              An <strong>Interim CMO</strong> is a temporary Chief Marketing Officer who works full-time for a defined period—typically 3-12 months. Unlike interim CMOs who work part-time, interim CMOs focus exclusively on one organisation during their engagement.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-8">Interim CMO vs Interim CMO</h2>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  <th className="p-4 text-left font-bold">Interim CMO</th>
                </tr>
              </thead>
              <tbody>
      ...
      <section id="contact" className="py-20 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10">Tell us about your situation and we'll help you find the right interim or interim CMO.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/interim-cmo-services" className="px-10 py-5 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">Explore Interim CMO</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/interim-cmo-services" className="text-gray-600 hover:text-amber-600 font-medium">Interim CMO</Link>
