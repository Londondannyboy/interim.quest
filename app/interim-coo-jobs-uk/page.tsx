          ...
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="/interim-jobs-startups" className="px-8 py-4 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">
                  Startup COO Jobs
                </Link>
              </div>
            </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-8 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-black text-gray-900">How Much Can You Earn as a Interim COO?</h2>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">
              Everything You Need to Know About<br /><span className="text-orange-600">Interim COO Jobs UK</span>
            </h2>
            <div className="w-24 h-1 bg-orange-500"></div>
          </div>
          <figure className="mb-16 -mx-6 lg:-mx-16">
            <img src="https://images.pexels.com/photos/3184338/pexels-photo-3184338.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="Interim COO jobs UK - operations executive leading team planning session" className="w-full h-80 md:h-96 object-cover" />
            <figcaption className="text-sm text-gray-500 mt-3 px-6 lg:px-16">Operations leaders across the UK are embracing interim work</figcaption>
          </figure>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-black text-gray-900">Common Questions About Interim COO Jobs UK</h2>
          </div>
      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/interim-jobs-startups" className="text-gray-600 hover:text-orange-600 font-medium transition-colors">Startup COO Jobs</Link>
              <Link href="/interim-cmo-jobs-uk" className="text-gray-600 hover:text-orange-600 font-medium transition-colors">CMO Jobs UK</Link>
              <Link href="/interim-cfo-jobs-uk" className="text-gray-600 hover:text-orange-600 font-medium transition-colors">CFO Jobs UK</Link>
              <Link href="/interim-cto-jobs-uk" className="text-gray-600 hover:text-orange-600 font-medium transition-colors">CTO Jobs UK</Link>
            </div>
          </div>
        </div>
      </section>
