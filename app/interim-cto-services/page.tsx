      ...
      <section className="py-12 bg-white border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/interim-cfo-services" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Interim CFO Services</Link>
              <Link href="/interim-cmo-services" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Interim CMO Services</Link>
              <Link href="/interim-coo-services" className="text-gray-600 hover:text-blue-600 font-medium transition-colors">Interim COO Services</Link>
