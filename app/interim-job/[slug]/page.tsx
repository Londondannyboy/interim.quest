...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  try {
    ...
    if (jobs.length === 0) {
      return { title: 'Job Not Found | Interim Quest' }
    }
            ...
            >
              <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="mb-8" style={{ color: colors.text, opacity: 0.8 }}>
                  Join {job.company_name} and take the next step in your interim executive career.
                </p>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <Link
                    ...
                    aria-label="Browse all interim jobs on Interim Quest"
                  >
