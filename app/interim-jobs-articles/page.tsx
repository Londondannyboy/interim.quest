        ...
        <section className="py-12 bg-gray-50 border-b border-gray-200">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex flex-wrap justify-center gap-3">
              {[
                { label: 'All Guides', href: '/interim-jobs-articles', active: true },
                { label: 'CFO Guides', href: '/interim-jobs-articles?category=cfo' },
                { label: 'CTO Guides', href: '/interim-jobs-articles?category=cto' },
                { label: 'CMO Guides', href: '/interim-jobs-articles?category=cmo' },
                { label: 'Salary Guides', href: '/interim-jobs-articles?category=salary' },
                { label: 'Career Tips', href: '/interim-jobs-articles?category=career' },
              ].map((cat) => (
                <Link
                  key={cat.label}
                  href={cat.href}
        ...
        <section className="py-16 bg-gray-950">
          <div className="max-w-5xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 mt-2 text-sm">When interim jobs are posted throughout the year</p>
            </div>
            <Suspense fallback={
              ...
              <>
                ...
                {totalPages > 1 && (
                  <div className="flex justify-center items-center gap-2">
                    {page > 1 && (
                      <Link href={`/interim-jobs-articles?page=${page - 1}`}>
                    ...
                    <div className="flex gap-1">
                      {Array.from({ length: Math.min(5, totalPages) }).map((_, i) => {
                        ...
                        return (
                          <Link key={pageNum} href={`/interim-jobs-articles?page=${pageNum}`}>
                            <button
