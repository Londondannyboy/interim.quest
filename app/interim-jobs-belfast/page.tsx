...
export const metadata: Metadata = {
  title: 'Interim Jobs Belfast - Executive Roles in Northern Ireland',
  description: 'Find interim executive jobs in Belfast. CFO, CMO, CTO roles in Northern Ireland. £500-£900 daily rates. Cyber security, fintech, and tech hub.',
  openGraph: {
    title: 'Interim Jobs Belfast - Executive Roles in Northern Ireland',
    description: 'Find interim executive jobs in Belfast, Northern Ireland\'s tech capital.',
    type: 'website',
  },
}
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Belfast?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Belfast?
                <span className="text-emerald-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Why is Belfast good for tech interim roles?
                <span className="text-emerald-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Belfast has Europe's largest cyber security cluster with 100+ companies. Global tech firms like Proofpoint and Rapid7 have major operations here, creating excellent interim CTO and CISO opportunities.
              </p>
            </details>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-emerald-700">Interim CFO Jobs</Link></li>
                <li><Link href="/cto" className="hover:text-emerald-700">Interim CTO Jobs</Link></li>
                <li><Link href="/cmo" className="hover:text-emerald-700">Interim CMO Jobs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-emerald-700">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-edinburgh" className="hover:text-emerald-700">Interim Jobs Edinburgh</Link></li>
                <li><Link href="/interim-jobs-glasgow" className="hover:text-emerald-700">Interim Jobs Glasgow</Link></li>
              </ul>
            </div>
