            ...
            <div className="flex flex-col lg:flex-row justify-between items-end gap-8">
              ...
              <div className="max-w-2xl">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
                  ...
                  <img
                    src="/images/interim-jobs-birmingham.svg"
                    alt="Interim Jobs Birmingham - Executive recruitment opportunities in the Midlands"
                    className="hidden"
                    width={1}
                    height={1}
                  />
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/interim-jobs?location=Birmingham"
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Birmingham Interim Jobs</h2>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">Find interim roles across the West Midlands</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">Key sectors hiring interim executives</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              ...
              <p className="text-gray-600">
                18% YoY growth in interim roles. HS2 and city regeneration driving demand for senior talent.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">Understand your take-home as a interim executive in Birmingham</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">About interim work in Birmingham</p>
          </div>
