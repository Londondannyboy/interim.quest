      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Find interim roles from Bristol to Bath</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-gray-600">
                Home to Airbus, Rolls-Royce, and 100+ aerospace companies. Premium rates for interim CFOs and CTOs with aerospace experience.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">
                Bristol's creative and media sector is thriving - from Aardman Animations to digital agencies. Perfect for interim CMOs.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-6">
              ...
              <p className="text-gray-600">
                Bristol was European Green Capital 2015. Cleantech and sustainability sectors are booming with 25% YoY growth in interim roles.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <details className="group bg-white rounded-xl p-6 cursor-pointer">
              ...
              <p className="mt-4 text-gray-600">
                Yes - Bristol's tech scene has grown significantly with Temple Quarter Enterprise Zone. Companies like Just Eat, OVO Energy, and numerous scale-ups hire interim CTOs and tech leaders.
              </p>
            </details>
            <details className="group bg-white rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
              ...
              <p className="mt-4 text-gray-600">
                Very easy. Bristol is 1hr 45min from London Paddington by train. Many interim executives maintain clients in both cities, benefiting from Bristol's lower costs and quality of life.
              </p>
            </details>
          </div>
        </div>
