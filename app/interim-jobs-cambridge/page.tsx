...
export const metadata: Metadata = {
  title: 'Interim Jobs Cambridge - Executive Roles in the Silicon Fen',
  description: 'Find interim executive jobs in Cambridge. CFO, CMO, CTO roles in Silicon Fen. £700-£1,200 daily rates. Deep tech, biotech, and AI hub.',
  openGraph: {
    title: 'Interim Jobs Cambridge - Executive Roles in Silicon Fen',
    description: 'Find interim executive jobs in Cambridge, the UK\'s deep tech and biotech capital.',
    type: 'website',
  },
}
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Cambridge?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Cambridge?
                <span className="text-cyan-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-cyan-700">Interim CFO Jobs</Link></li>
                <li><Link href="/cto" className="hover:text-cyan-700">Interim CTO Jobs</Link></li>
                <li><Link href="/cmo" className="hover:text-cyan-700">Interim CMO Jobs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-cyan-700">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-oxford" className="hover:text-cyan-700">Interim Jobs Oxford</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-cyan-700">Interim Jobs Manchester</Link></li>
              </ul>
            </div>
