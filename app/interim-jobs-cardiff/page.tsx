...
export const metadata: Metadata = {
  title: 'Interim Jobs Cardiff - Executive Roles in Wales',
  description: 'Find interim executive jobs in Cardiff. CFO, CMO, CTO roles in the Welsh capital. £500-£900 daily rates. FinTech, creative, and professional services hub.',
  openGraph: {
    title: 'Interim Jobs Cardiff - Executive Roles in Wales',
    description: 'Find interim executive jobs in Cardiff, Wales\' business capital.',
    type: 'website',
  },
}
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Cardiff?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Cardiff?
                <span className="text-green-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Why is Cardiff good for fintech interim roles?
                <span className="text-green-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-green-700">Interim CFO Jobs</Link></li>
                <li><Link href="/cmo" className="hover:text-green-700">Interim CMO Jobs</Link></li>
                <li><Link href="/cto" className="hover:text-green-700">Interim CTO Jobs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-green-700">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-bristol" className="hover:text-green-700">Interim Jobs Bristol</Link></li>
                <li><Link href="/interim-jobs-birmingham" className="hover:text-green-700">Interim Jobs Birmingham</Link></li>
              </ul>
            </div>
