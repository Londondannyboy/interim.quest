    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/interim-jobs?location=Glasgow"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-600 font-medium">of Scottish interim roles</div>
            </div>
            <div>
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">From the City Centre to the West End - find interim roles across Glasgow</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {areaJobEstimates.map((area) => (
              <Link
                key={area.name}
                href={`/interim-jobs?location=${encodeURIComponent(area.name)}`}
                className="group"
              >
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '💰', title: 'Interim CFO Glasgow', rate: '£700-£1,100/day', role: 'CFO' },
              ...
              return (
                <Link
                  key={item.role}
                  href={`/interim-jobs?location=Glasgow&role=${item.role}`}
                  className="group"
                >
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Scotland's innovation capital for interim executive careers</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-gray-600">
                World-class life sciences and healthcare innovation with university spin-outs and research-led companies seeking interim leadership.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">High-growth sectors hiring interim executives in Glasgow</p>
          </div>
        ...
        <section className="py-20 md:py-28 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Hand-picked interim executive positions in Glasgow</p>
            </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Everything you need to know about interim jobs in Glasgow</p>
          </div>

          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Glasgow?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Which industries hire interim executives in Glasgow?
                <span className="text-blue-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Glasgow's key industries for interim work include tech/SaaS, life sciences, fintech, energy, and creative industries. The city has a strong university spin-out ecosystem and growing tech scene in areas like Finnieston and Merchant City.
              </p>
            </details>
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How does Glasgow compare to Edinburgh for interim work?
                <span className="text-blue-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Glasgow has a larger tech startup scene and more diverse industry base, while Edinburgh has stronger financial services. Many interim executives work with companies in both cities. Glasgow offers better value with similar professional opportunities.
              </p>
            </details>

            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Are there interim recruitment agencies in Glasgow?
                <span className="text-blue-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-blue-700 transition-colors">Interim CFO Jobs</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs" className="hover:text-blue-700 transition-colors">All Interim Jobs UK</Link></li>
                <li><Link href="/interim-jobs-london" className="hover:text-blue-700 transition-colors">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-edinburgh" className="hover:text-blue-700 transition-colors">Interim Jobs Edinburgh</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-blue-700 transition-colors">Interim Jobs Manchester</Link></li>
                <li><Link href="/remote" className="hover:text-blue-700 transition-colors">Remote Interim Jobs UK</Link></li>
              </ul>
            </div>
      ...
      <section className="py-20 md:py-28 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10">
            {stats.totalGlasgow}+ interim executive opportunities in Scotland's largest business hub.
          </p>
          <Link
            href="/interim-jobs?location=Glasgow"
            className="inline-flex items-center justify-center px-10 py-5 text-lg font-semibold rounded-lg bg-white text-blue-900 hover:bg-blue-50 transition-all duration-200"
