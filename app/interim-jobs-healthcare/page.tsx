...
const healthcareRoles = [
  { icon: '💰', title: 'Interim CFO Healthcare', rate: '£850-£1,300/day', desc: 'Fundraising, Series A-D, IPO preparation' },
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Healthcare Interim Jobs</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {healthcareHubs.map((hub) => (
              <Link key={hub.name} href={`/interim-jobs-${hub.name.toLowerCase()}`} className="group">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">Understand your take-home as a healthcare interim executive</p>
          </div>
