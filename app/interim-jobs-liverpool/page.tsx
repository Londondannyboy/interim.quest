...
export const metadata: Metadata = {
  title: 'Interim Jobs Liverpool - Executive Roles in the North West',
  description: 'Find interim executive jobs in Liverpool. CFO, CMO, CTO roles across the Liverpool City Region. £550-£1,000 daily rates. Digital, creative, and maritime hub.',
  openGraph: {
    title: 'Interim Jobs Liverpool - Executive Roles in the North West',
    description: 'Find interim executive jobs in Liverpool. CFO, CMO, CTO roles across the Liverpool City Region.',
    type: 'website',
  },
}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '💰', title: 'Interim CFO Liverpool', rate: '£600-£1,000/day', role: 'CFO' },
              ...
              return (
                <Link
                  key={item.role}
                  href={`/interim-jobs?location=Liverpool&role=${item.role}`}
                  className="group"
                >
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">High-growth sectors hiring interim executives</p>
          </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Everything about interim jobs in Liverpool</p>
          </div>

          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Liverpool?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Liverpool?
                <span className="text-red-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What's Baltic Triangle like for interim work?
                <span className="text-red-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Baltic Triangle is Liverpool's creative and tech hub with over 500 businesses. It's ideal for interim CMOs and CTOs working with digital agencies, startups, and creative companies. The area has a vibrant, collaborative atmosphere.
              </p>
            </details>
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              ...
              <p className="mt-4 text-gray-600 leading-relaxed">
                Yes, many interim executives work across the North West, combining Liverpool and Manchester clients. The cities are only 35 minutes apart by train, making it easy to serve both markets.
              </p>
            </details>

            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Which industries hire interim executives in Liverpool?
                <span className="text-red-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-red-700 transition-colors">Interim CFO Jobs</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs" className="hover:text-red-700 transition-colors">All Interim Jobs UK</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-red-700 transition-colors">Interim Jobs Manchester</Link></li>
                <li><Link href="/interim-jobs-london" className="hover:text-red-700 transition-colors">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-leeds" className="hover:text-red-700 transition-colors">Interim Jobs Leeds</Link></li>
                <li><Link href="/remote" className="hover:text-red-700 transition-colors">Remote Interim Jobs</Link></li>
              </ul>
            </div>
