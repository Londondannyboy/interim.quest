...
const successStories = [
  ...
  {
    quote: "The flexibility of interim work combined with London's premium rates is unbeatable.",
    name: "Sophie W.",
    role: "Interim CMO",
    area: "Canary Wharf",
  },
            ...
            <div className="flex flex-col lg:flex-row justify-between items-end gap-8">
              ...
              <div className="max-w-2xl">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
                  ...
                  <img
                    src="/images/interim-jobs-london.svg"
                    alt="Interim Jobs London - Executive recruitment opportunities in the City, Shoreditch and Canary Wharf"
                    className="hidden"
                    width={1}
                    height={1}
                  />
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/interim-jobs?location=London"
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
              London dominates the UK<br />interim executive market
            </h2>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">Where interim executives thrive</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '💰', title: 'Interim CFO', subtitle: 'Finance Leadership', rate: '£900-£1,400/day', role: 'CFO' },
              ...
              return (
                <Link
                  key={item.role}
                  href={`/interim-jobs?location=London&role=${item.role}`}
                  className="group"
                >
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">London Interim Jobs</h2>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">Understand your take-home as a interim executive in London</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">About interim work in London</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            {stats.totalLondon}+ interim executive opportunities across London's top startups and scale-ups.
          </p>
