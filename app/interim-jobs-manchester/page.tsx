            ...
            <div className="flex flex-col lg:flex-row justify-between items-end gap-8">
              ...
              <div className="max-w-2xl">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
                  ...
                  <img
                    src="/images/interim-jobs-manchester.svg"
                    alt="Interim Jobs Manchester - Executive recruitment opportunities in the North West"
                    className="hidden"
                    width={1}
                    height={1}
                  />
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Manchester Interim Jobs</h2>
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Interim Jobs Manchester by Area</h2>
            <p className="text-xl text-gray-600">Find interim roles from the City to MediaCity</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              ...
              <p className="text-gray-600">
                MediaCityUK hosts BBC, ITV, and dozens of production companies. Perfect for interim CMOs in media.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-sm">
              <div className="w-14 h-14 bg-purple-100 rounded-xl flex items-center justify-center mb-6">
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">Understand your take-home as a interim executive in Manchester</p>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">About interim work in Manchester</p>
          </div>
