...
export const metadata: Metadata = {
  title: 'Interim Jobs Newcastle - Executive Roles in the North East',
  description: 'Find interim executive jobs in Newcastle. CFO, CMO, CTO roles in the North East. £500-£950 daily rates. Tech, digital, and professional services hub.',
  openGraph: {
    title: 'Interim Jobs Newcastle - Executive Roles in the North East',
    description: 'Find interim executive jobs in Newcastle. Tech, digital, and professional services hub.',
    type: 'website',
  },
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {newcastleAreas.map((area, i) => (
              <Link key={area.name} href={`/interim-jobs?location=${encodeURIComponent(area.name)}`} className="group">
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Newcastle?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Newcastle?
                <span className="text-slate-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Which industries hire interim executives in Newcastle?
                <span className="text-slate-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Key industries include tech/digital, gaming, life sciences, energy, and fintech. The gaming sector (Ubisoft, Sumo Digital) is particularly strong for interim leadership.
              </p>
            </details>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-slate-700">Interim CFO Jobs</Link></li>
                <li><Link href="/cmo" className="hover:text-slate-700">Interim CMO Jobs</Link></li>
                <li><Link href="/cto" className="hover:text-slate-700">Interim CTO Jobs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-slate-700">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-slate-700">Interim Jobs Manchester</Link></li>
                <li><Link href="/interim-jobs-leeds" className="hover:text-slate-700">Interim Jobs Leeds</Link></li>
              </ul>
            </div>
