...
export const metadata: Metadata = {
  title: 'Interim Jobs Oxford - Executive Roles in the Innovation Hub',
  description: 'Find interim executive jobs in Oxford. CFO, CMO, CTO roles in the Oxford cluster. £700-£1,100 daily rates. Life sciences, AI, and deep tech hub.',
  openGraph: {
    title: 'Interim Jobs Oxford - Executive Roles in the Innovation Hub',
    description: 'Find interim executive jobs in Oxford, the UK\'s life sciences and AI innovation hub.',
    type: 'website',
  },
}
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What is an interim job in Oxford?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do interim executives earn in Oxford?
                <span className="text-indigo-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-indigo-700">Interim CFO Jobs</Link></li>
                <li><Link href="/cto" className="hover:text-indigo-700">Interim CTO Jobs</Link></li>
                <li><Link href="/cmo" className="hover:text-indigo-700">Interim CMO Jobs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-indigo-700">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-cambridge" className="hover:text-indigo-700">Interim Jobs Cambridge</Link></li>
                <li><Link href="/interim-jobs-bristol" className="hover:text-indigo-700">Interim Jobs Bristol</Link></li>
              </ul>
            </div>
