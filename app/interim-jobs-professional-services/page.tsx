    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20 md:py-28 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '💰', title: 'Interim CFO', rate: '£650-£1,050/day', desc: 'Partner economics, WIP management, cash flow' },
          ...
          <div className="space-y-6">
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                What experience do I need for PS interim roles?
            ...
            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                How much do PS interim executives earn?
                <span className="text-gray-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Professional services interim executives earn £600-£1,100 per day. Specialists in digital transformation and legal/accounting tech command premium rates. Most work with 3-4 firms, earning £120,000-£170,000+ annually.
              </p>
            </details>

            <details className="group bg-gray-50 rounded-xl p-6 cursor-pointer">
              <summary className="flex justify-between items-center font-bold text-lg text-gray-900 list-none">
                Which PS firms hire interim executives?
                <span className="text-gray-700 group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="mt-4 text-gray-600 leading-relaxed">
                Mid-market firms (£5m-£50m revenue) are the primary market. They've outgrown partner-led operations but can't justify full C-suite. Growing boutiques and firms undergoing digital transformation also hire interim executives.
              </p>
            </details>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/cfo" className="hover:text-gray-900">Interim CFO</Link></li>
                <li><Link href="/coo" className="hover:text-gray-900">Interim COO</Link></li>
                <li><Link href="/cto" className="hover:text-gray-900">Interim CTO</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-london" className="hover:text-gray-900">London</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-gray-900">Manchester</Link></li>
                <li><Link href="/interim-jobs-birmingham" className="hover:text-gray-900">Birmingham</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li><Link href="/interim-jobs-finance" className="hover:text-gray-900">Finance</Link></li>
                <li><Link href="/interim-jobs-tech" className="hover:text-gray-900">Tech</Link></li>
                <li><Link href="/interim-jobs-saas" className="hover:text-gray-900">SaaS</Link></li>
              </ul>
            </div>
          </div>
        </div>
