...
const startupRoles = [
  { name: 'Interim CFO', icon: '💰', description: 'Fundraising, board reporting, finance ops' },
              ...
              <div className="max-w-2xl">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link
                      href="/interim-jobs?industry=Startups"
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Startup Interim Jobs</h2>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-5xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-500">Understand your take-home as an interim at a startup</p>
          </div>
