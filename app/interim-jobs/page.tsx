...
export default async function JobsPage({ searchParams }: JobsPageProps) {
  ...
  try {
    ...
    const buildPageUrl = (pageNum: number) => {
      ...
      return `/interim-jobs?${params.toString()}`
    }
        ...
        <section className="py-20 md:py-28 bg-gray-900">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              ...
              <Link href="/interim-cfo-salary" className="group">
                <article className="p-6 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-white/20">
                  <span className="text-3xl mb-4 block">📊</span>
              ...
              <Link href="/interim-cmo-salary" className="group">
                <article className="p-6 bg-white/5 rounded-xl hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-white/20">
                  <span className="text-3xl mb-4 block">📈</span>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {[
                { label: 'London', href: '/interim-jobs-london' },
                { label: 'Manchester', href: '/interim-jobs-manchester' },
                { label: 'Birmingham', href: '/interim-jobs-birmingham' },
                { label: 'Edinburgh', href: '/interim-jobs-edinburgh' },
                { label: 'Bristol', href: '/interim-jobs-bristol' },
                { label: 'Leeds', href: '/interim-jobs-leeds' },
              ].map((loc) => (
                <Link
                  key={loc.label}
                  href={loc.href}
