...
export const metadata: Metadata = {
  title: 'Interim Marketing Agency UK | Part-Time Marketing Support',
  description: 'Access interim marketing agency services. Part-time marketing strategy, campaigns, and execution. Agency expertise without full agency retainers.',
  keywords: 'interim marketing agency, part-time marketing agency, interim marketing services, interim marketing support uk',
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-2xl mb-8">Access marketing agency expertise on an interim basis. Get strategic marketing leadership and execution without the overhead of traditional agency retainers.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <h2 className="text-3xl font-black text-gray-900 mb-6">What is a Interim Marketing Agency?</h2>
          <p className="text-xl text-gray-600 leading-relaxed mb-6">An interim marketing agency provides ongoing marketing strategy and execution on a part-time, retained basis. Instead of expensive full-service agency retainers, you get focused marketing support tailored to your specific needs and budget.</p>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-4 text-left font-bold text-amber-700">Interim Agency</th>
      ...
      <section id="contact" className="py-20 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-black mb-6">Get Interim Marketing Support</h2>
          <p className="text-xl text-gray-400 mb-10">Tell us about your marketing needs and we'll match you with the right interim marketing expertise.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/interim-marketing" className="px-10 py-5 border-2 border-white text-white font-bold uppercase tracking-wider hover:bg-white hover:text-black transition-colors">Marketing Leadership</Link>
          </div>
        </div>
      </section>
    </div>
