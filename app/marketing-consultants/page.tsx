    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-2xl mb-8">Hire experienced marketing professionals on an interim basis. Get expert marketing strategy and execution without the cost of a full marketing team.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Marketing consultants help businesses attract customers, build brands, and drive growth. On an interim basis, they bring senior marketing expertise without the commitment of a full-time hire.</p>
