    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-2xl mb-8">Hire experienced operations professionals on an interim basis. Get expert operational strategy and execution without the cost of a full operations team.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Operations consultants help businesses run more efficiently, scale sustainably, and build systems that work. On an interim basis, they bring COO-level expertise without the full-time commitment.</p>
