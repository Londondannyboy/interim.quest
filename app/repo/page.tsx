    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className={`${sidebarOpen ? 'w-72' : 'w-20'} bg-white border-r border-gray-200 flex flex-col transition-all duration-300 shadow-sm`}>
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          <NavItem icon={<BriefcaseIcon />} label="Jobs" href="/interimjobsuk" collapsed={!sidebarOpen} />
          <NavItem icon={<ArticleIcon />} label="Articles" href="/interim-jobs-articles" collapsed={!sidebarOpen} />
