    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 w-full py-20">
          <div className="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-white/80 leading-relaxed max-w-2xl mb-8">Hire experienced technology professionals on an interim basis. Get expert technical strategy and architecture without the cost of a full technology team.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">Technology consultants help businesses make the right technical decisions, build great products, and scale their engineering capabilities. On an interim basis, they bring CTO-level expertise without the full-time commitment.</p>
