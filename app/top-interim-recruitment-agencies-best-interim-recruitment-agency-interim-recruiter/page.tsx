                ...
                <form className="space-y-4" action="/contact/companies" method="GET">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="cfo">Interim CFO</option>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <figure className="mb-12 -mx-6 lg:-mx-16">
            ...
            <figcaption className="text-sm text-gray-500 mt-3 px-6 lg:px-16">
              A specialist interim recruitment agency connects businesses with experienced part-time executives
            </figcaption>
          </figure>
          ...
          <article className="prose prose-lg prose-gray max-w-none">
            ...
            <div className="bg-gray-50 p-8 my-10 border-l-4 border-amber-500">
              <p className="text-xl font-semibold text-gray-900 mb-0">
                "Working with a specialist interim recruitment agency typically costs 10-20% of engagement value—often less than traditional executive search fees of 25-33%."
              </p>
            </div>
      ...
      <section className="py-20 bg-black text-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            We're building a better interim recruitment agency. Register your interest and be first to know when we launch.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/interim-coo-jobs-uk" className="text-gray-600 hover:text-amber-600 font-medium transition-colors">Interim COO Jobs</Link>
              <Link href="/interimjobsuk" className="text-gray-600 hover:text-amber-600 font-medium transition-colors">All Jobs</Link>
            </div>
          </div>
        </div>
      </section>
