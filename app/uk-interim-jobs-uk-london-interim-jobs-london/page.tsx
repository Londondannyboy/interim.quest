              ...
              <div className="max-w-2xl">
                <div className="bg-black/40 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-white/10">
                  ...
                  <p className="text-lg text-white/70 mb-8 leading-relaxed max-w-lg">
                    Find interim jobs UK wide. From interim jobs London to Manchester, Birmingham and beyond. CFO, CMO, CTO roles with £800-£1,500 daily rates.
                  </p>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-xs font-medium uppercase tracking-[0.3em] text-gray-400 mb-4 block">Interim Jobs UK</span>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8 leading-tight">
              Your marketplace<br />for interim jobs UK
            </h2>
          </div>
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-500">Find interim jobs UK wide</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {regionJobEstimates.map((region) => (
              <Link
                key={region.name}
                href={region.name === 'London' ? '#london-jobs' : `/interim-jobs-${region.name.toLowerCase()}`}
                className="group"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {londonAreas.map((area) => (
              <Link
                key={area.name}
                href={`/interim-jobs?location=${encodeURIComponent(area.name.split('/')[0])}`}
                className="group"
              >
      ...
      <section className="py-24 md:py-32 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: '&#128176;', title: 'Interim CFO Jobs UK', subtitle: 'Finance Leadership', rate: '£800-£1,400/day', role: 'CFO', link: '/interim-cfo-jobs-uk' },
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="flex justify-between items-end mb-12">
              <div>
                ...
                <h2 className="text-4xl font-bold text-gray-900">Interim Jobs UK & London</h2>
              </div>
              <Link
                href="/interim-jobs"
      ...
      <section className="py-24 md:py-32 bg-gray-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Interim Jobs UK Success Stories</h2>
          </div>
      ...
      <section className="py-24 md:py-32 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900">Interim Jobs UK - Common Questions</h2>
          </div>
      ...
      <section className="py-16 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="font-bold text-gray-900 mb-4 text-sm uppercase tracking-wider">Interim Jobs UK by Role</h3>
              <ul className="space-y-3 text-gray-600">
                <li><Link href="/interim-cfo-jobs-uk" className="hover:text-purple-700 transition-colors">Interim CFO Jobs UK</Link></li>
                <li><Link href="/interim-cmo-jobs-uk" className="hover:text-purple-700 transition-colors">Interim CMO Jobs UK</Link></li>
                <li><Link href="/interim-cto-jobs-uk" className="hover:text-purple-700 transition-colors">Interim CTO Jobs UK</Link></li>
                <li><Link href="/interim-coo-jobs-uk" className="hover:text-purple-700 transition-colors">Interim COO Jobs UK</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="font-bold text-gray-900 mb-4 text-sm uppercase tracking-wider">Interim Jobs UK by Location</h3>
              <ul className="space-y-3 text-gray-600">
                <li><Link href="/interim-jobs?location=London" className="hover:text-purple-700 transition-colors">Interim Jobs London</Link></li>
                <li><Link href="/interim-jobs-manchester" className="hover:text-purple-700 transition-colors">Interim Jobs Manchester</Link></li>
                <li><Link href="/interim-jobs-birmingham" className="hover:text-purple-700 transition-colors">Interim Jobs Birmingham</Link></li>
                <li><Link href="/interim-jobs-edinburgh" className="hover:text-purple-700 transition-colors">Interim Jobs Edinburgh</Link></li>
              </ul>
            </div>
            <div>
      ...
      <section className="py-24 md:py-32 bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
            Find Interim Jobs UK Today
          </h2>
          <p className="text-xl text-gray-400 mb-10 max-w-2xl mx-auto">
            {stats.totalUK}+ interim jobs UK including {stats.totalLondon}+ interim jobs London. Join the UK&apos;s fastest-growing executive job market.
          </p>
