    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="bg-black/50 border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <p className="text-gray-400 mt-2">Interactive data visualizations for interim jobs</p>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 space-y-16">
        ...
        <section>
          <div className="mb-6">
            ...
            <p className="text-gray-400 mt-2">Distribution of day rates across interim jobs</p>
          </div>
