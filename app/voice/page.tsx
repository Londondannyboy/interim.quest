    ...
    <div className="flex flex-col items-center gap-8">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-600 mt-1">
          {isConnected ? 'Ask about interim jobs, day rates, or career advice' : 'Voice-powered job search assistant'}
        </p>
      </div>
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            ...
            "How do I transition to interim work?",
          ].map((question, index) => (
            <div
              key={index}
      ...
      <div className="bg-purple-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-purple-100">
            Talk to our AI assistant about interim jobs, day rates, and career opportunities
          </p>
        </div>
      </div>
