...
export function Navigation() {
  ...
  const navLinks = [
    ...
    { href: '/interim-services', label: 'Services' },
    { href: '/interim-jobs', label: 'Interim Jobs' },
    { href: '/interim-jobs-articles', label: 'Knowledge Base' }
  ]
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="hidden sm:block">
              <span className="font-bold text-gray-900 text-lg">Interim</span>
